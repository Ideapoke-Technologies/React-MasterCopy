...
import Arrowhover from './images/hover-arrow-right.svg'
...
export default function ProfileMemberhover(props) {
...
{props.propcollabratorData && (
        <MemeberCardWrapper>
            ...
            <MemeberLHS>
            <Profilewraper>
            { props.propcollabratorData.userPhoto =="null"||props.propcollabratorData.userPhoto =="" ?<ProfileNoImg>{props.initials}</ProfileNoImg> :<MemberHoverBg
    ...
    <MemeberRHS>
        <MemeberRHSTop>
            <MemeberRTL>
                ...
                <MemberHoverTetx text={fullName}></MemberHoverTetx>
                <div style={{margin: "0px"}}>
                <P  text={props.propcollabratorData.emailId} color="#1A5C97" fontSize="12px" fontWeight="400"></P>
                <P text={props.propcollabratorData.companyName} color="#979797" fontSize="12px" fontWeight="400" linehight="30px"></P> 
                </div>  
            </MemeberRTL>
            <MemeberRTR style={{marginRight: "50px", marginTop: "10px"}} >
                <Rightext>
                    <P  text={t('role')} color="#454545" fontSize="12px" fontWeight="500"></P>
                    <P  text={
                        props.propcollabratorData.roleType == "null"
                          ? "MEMBER"
                          : props.propcollabratorData.roleType
                      } color="#5F5F5F" fontSize="10px" fontWeight="400"></P>
                </Rightext>
            </MemeberRTR>                
        </MemeberRHSTop>
        <MemeberRHSBottom>
            <MemeberRHSTop2>
                <MemeberRTL2>
                    <P text={t('recentlycollaborateddesign')} color="#454545;" fontSize="12px" fontWeight="400"></P>                       
                </MemeberRTL2>
                <MemeberRTR2>
                    <P text={t('lastupdated')} color="#454545" fontSize="12px" fontWeight="500"></P>
                </MemeberRTR2>                
            </MemeberRHSTop2>
            <MemeberRHSTop2>
                <MemeberRTL3>
                    <P text={collabDesignName} color="#5F5F5F" fontSize="11px" fontWeight="400"></P>                       
                </MemeberRTL3>
                <MemeberRTR3>
                    <P  text={props.propcollabratorData.updatedDate ?formatDate(props.propcollabratorData.updatedDate):"" } color="#5F5F5F" fontSize="11px" fontWeight="400"></P>
                </MemeberRTR3>                
            </MemeberRHSTop2>
        </MemeberRHSBottom>
    </MemeberRHS>
